...
<section class="py-5 bg-light">
  <div class="container">
    ...
    <div class="text-center mt-5">
      <a href="{{ route('pricing.index') }}" class="btn btn-success btn-lg fw-bold" style="background: linear-gradient(135deg, #228B22, #1c751c); border: none;">
        Lihat Harga Lengkap
      </a>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 mb-4 mb-lg-0">
        ...
        <a href="{{ route('mitra.show') }}" class="btn btn-success btn-lg fw-bold" style="background: linear-gradient(135deg, #228B22, #1c751c); border: none;">
      ...
      <div class="col-md-4">
        <div class="card border-0 shadow-sm card-raise">
          ...
          <div class="card-body">
            ...
            <a href="{{ route('artikel.index') }}" class="link-success text-decoration-none fw-bold">Baca selengkapnya →</a>
          </div>
        </div>
      </div>
