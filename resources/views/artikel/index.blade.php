...
@push('head')
  <meta name="description" content="Artikel pemilahan sampah, tips daur ulang, dan manfaat recycle. Edukasi lingkungan yang ringkas dan mudah dipraktikkan.">
  ...
  <div class="container">
    <div class="row align-items-center g-4 mb-2">
      <div class="col-lg-8">
        ...
        <p class="text-muted mb-0">Pelajari pemilahan sampah, tips daur ulang, dan manfaat ekonomi sirkular. Mulai dari langkah kecil untuk dampak besar.</p>
      </div>
    </div>
  </div>
  </section>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card h-100 shadow-sm card-raise">
              <div class="ratio ratio-16x9">
                <img src="{{ $a->image }}" class="card-img-top object-fit-cover" alt="{{ $a->title }}" onerror="this.src='https://via.placeholder.com/600x338?text=Artikel';">
              </div>
              <div class="card-body d-flex flex-column">
                ...
                <a href="{{ route('artikel.show', ['slug' => $a->slug]) }}" class="stretched-link link-success">Baca selengkapnya</a>
              </div>
            </div>
          </div>
        @endforeach
