  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10 col-xl-8">
        <img src="{{ $article->image }}" class="img-fluid rounded shadow-sm mb-4" alt="{{ $article->title }}" onerror="this.src='https://via.placeholder.com/1200x675?text=Artikel';">
        ...
        <div class="d-flex justify-content-between">
          ...
          <a href="#" class="btn btn-success">Bagikan</a>
        </div>
      </div>
    </div>
  </div>
