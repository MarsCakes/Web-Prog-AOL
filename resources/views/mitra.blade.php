...
@push('head')
  <meta name="description" content="Daftar sebagai mitra/driver GREEN. Baca penjelasan sistem kemitraan, manfaat jadi mitra, serta syarat & ketentuan.">
  ...
  <div class="container">
    ...
    <div class="row align-items-center g-4">
      <div class="col-lg-6">
        ...
        <p class="lead text-white opacity-90 mb-4">Gabung sebagai mitra penjemputan sampah, bantu lingkungan sekaligus menambah penghasilan. Jadwal fleksibel, dukungan tim, dan tarif transparan.</p>
          ...
          <div class="card-body p-4">
            ...
            <form method="POST" action="{{ route('mitra.submit') }}">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <select name="vehicle" class="form-select">
                    ...
                    <option value="Mobil Pick-up" {{ old('vehicle')=='Mobil Pick-up'?'selected':'' }}>Mobil Pick-up</option>
              ...
              <div class="form-check mb-3">
                <input class="form-check-input @error('agree') is-invalid @enderror" type="checkbox" name="agree" id="agree" {{ old('agree')?'checked':'' }} required>
                <label class="form-check-label fw-bold" for="agree">
                  Saya setuju dengan <a href="#" class="link-success">Syarat & Ketentuan</a>
                </label>
                @error('agree')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
              </div>
              <div class="d-grid">
                <button type="submit" class="btn btn-success btn-lg" style="background: linear-gradient(135deg, #228B22, #1c751c); border: none;">Daftar Sekarang</button>
              </div>
            </form>
          </div>
        </div>
    ...
    <div class="row g-4">
      <div class="col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm card-raise border-0">
          <div class="card-body p-4">
            <div class="p-4 rounded-3 mx-auto mb-3" style="background: linear-gradient(135deg, #e9f6e9, #d4f1d4); width: fit-content;">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#228B22" stroke-width="2"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"></path></svg>
            </div>
            <h3 class="h6 fw-bold">Pendapatan Tambahan</h3>
            <p class="text-muted small">Dapatkan penghasilan tambahan dari setiap order penjemputan sampah yang berhasil.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm card-raise border-0">
          <div class="card-body p-4">
            <div class="p-4 rounded-3 mx-auto mb-3" style="background: linear-gradient(135deg, #e9f6e9, #d4f1d4); width: fit-content;">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#228B22" stroke-width="2"><path d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-9h-3a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-3m-2 0V3a2 2 0 0 0-2 2v2h0m0 0H7m0 0a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"></path></svg>
            </div>
            <h3 class="h6 fw-bold">Dukungan Operasional</h3>
            <p class="text-muted small">Kami memberikan pelatihan lengkap dan dukungan CS untuk kesuksesan bisnis Anda.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm card-raise border-0">
          <div class="card-body p-4">
            <div class="p-4 rounded-3 mx-auto mb-3" style="background: linear-gradient(135deg, #e9f6e9, #d4f1d4); width: fit-content;">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#228B22" stroke-width="2"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7.1c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"></path></svg>
            </div>
            <h3 class="h6 fw-bold">Kontribusi Lingkungan</h3>
            <p class="text-muted small">Jadilah bagian dari gerakan ekonomi sirkular yang ramah lingkungan dan berkelanjutan.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm card-raise border-0">
          <div class="card-body p-4">
            <div class="p-4 rounded-3 mx-auto mb-3" style="background: linear-gradient(135deg, #e9f6e9, #d4f1d4); width: fit-content;">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#228B22" stroke-width="2"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
            </div>
            <h3 class="h6 fw-bold">Jadwal Fleksibel</h3>
            <p class="text-muted small">Atur jadwal kerja Anda sendiri sesuai ketersediaan dan kenyamanan pribadi Anda.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm card-raise border-0">
          <div class="card-body p-4">
            <div class="p-4 rounded-3 mx-auto mb-3" style="background: linear-gradient(135deg, #e9f6e9, #d4f1d4); width: fit-content;">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#228B22" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
            </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm card-raise border-0">
          <div class="card-body p-4">
            <div class="p-4 rounded-3 mx-auto mb-3" style="background: linear-gradient(135deg, #e9f6e9, #d4f1d4); width: fit-content;">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#228B22" stroke-width="2"><path d="M9 12l2 2 4-4m7 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            </div>
            <h3 class="h6 fw-bold">Transparansi Penuh</h3>
            <p class="text-muted small">Tarif jelas, insentif transparan, dan laporan penghasilan real-time untuk Anda.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card-body p-4">
            ...
            <ol class="list-group list-group-flush bg-transparent">
              ...
              <li class="list-group-item bg-transparent border-0 d-flex gap-3 pb-3">
                ...
                <span><strong>Pelatihan:</strong> Ikuti sesi pelatihan singkat (2-3 jam) tentang prosedur operasional.</span>
              </li>
