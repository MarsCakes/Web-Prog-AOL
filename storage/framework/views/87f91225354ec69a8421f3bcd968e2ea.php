<?php $__env->startSection('title', 'Beranda - GREEN'); ?>
<?php $__env->startSection('content'); ?>

<!-- Hero Section -->
<section class="hero-forest text-white py-5" style="background: linear-gradient(135deg, #228B22 0%, #1c751c 100%); min-height: 100vh; display: flex; align-items: center;">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 mb-4 mb-lg-0">
        ...
        <p class="lead mb-4">
          Jual sampah daur ulang Anda dengan mudah. Pesan penjemputan gratis, dapatkan uang tunai langsung, dan bantu selamatkan bumi.
        </p>
        <div class="d-flex gap-3 flex-wrap">
          <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-lg fw-bold px-5">
            Daftar Sekarang
          </a>
          <a href="<?php echo e(route('pricing.index')); ?>" class="btn btn-outline-light btn-lg fw-bold px-5">
            Lihat Harga
          </a>
        </div>
      ...
      <div class="col-lg-6">
        <img 
          ...
          style="width: 100%; max-width: 720px; height: 420px; object-fit: cover;"
          loading="lazy"
        />
      </div>
    </div>
...
<section class="py-5 bg-light">
  <div class="container">
    <div class="text-center mb-5">
      ...
      <div style="width: 80px; height: 4px; background: linear-gradient(135deg, #228B22, #90EE90); margin: 20px auto; border-radius: 2px;"></div>
    </div>
    ...
    <div class="row g-4">
      <div class="col-md-6 col-lg-3">
        <div class="text-center">
          <div style="background: linear-gradient(135deg, #228B22, #1c751c); color: white; width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 24px; font-weight: bold; margin: 0 auto 20px;">
            1
          </div>
...
<section class="py-5 bg-light">
  <div class="container">
    ...
    <div class="text-center mt-5">
      <a href="<?php echo e(route('pricing.index')); ?>" class="btn btn-success btn-lg fw-bold" style="background: linear-gradient(135deg, #228B22, #1c751c); border: none;">
        Lihat Harga Lengkap
      </a>
    </div>
  </div>
      ...
      <div class="col-md-4">
        <div class="card border-0 shadow-sm card-raise">
          <div class="card-body">
            ...
            <p class="card-text">
              "GREEN sangat membantu! Proses cepat, harga adil, dan sopirnya ramah. Saya sudah menjual sampah plastik saya dan dapat uang Rp 50.000!"
            </p>
      ...
      <div class="col-md-4">
        <div class="card border-0 shadow-sm card-raise">
          <div class="card-body">
            <div style="color: #FFC107; font-size: 18px; margin-bottom: 10px;">⭐⭐⭐⭐⭐</div>
            <p class="card-text">
              "Saya suka aplikasinya mudah digunakan. Dari pesan sampai pembayaran hanya 30 menit. Recommended untuk semua orang!"
            </p>
      ...
      <div class="col-md-4">
        <div class="card border-0 shadow-sm card-raise">
          <div class="card-body">
            <div style="color: #FFC107; font-size: 18px; margin-bottom: 10px;">⭐⭐⭐⭐⭐</div>
            <p class="card-text">
              "Tidak hanya untung, tapi juga bantu lingkungan. GREEN terbukti dapat mengurangi sampah rumah saya. Top deh!"
            </p>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 mb-4 mb-lg-0">
        ...
        <a href="<?php echo e(route('mitra.show')); ?>" class="btn btn-success btn-lg fw-bold" style="background: linear-gradient(135deg, #228B22, #1c751c); border: none;">
      ...
      <div class="col-lg-6">
        <img 
          ...
          style="width: 100%; max-width: 720px; height: 380px; object-fit: cover;"
          loading="lazy"
        />
      </div>
    </div>
...
<section class="py-5">
  <div class="container">
    ...
    <div class="row g-4">
      <div class="col-md-4">
        <div class="card border-0 shadow-sm card-raise">
          <div style="background: #f0f0f0; height: 200px; border-radius: 0.375rem 0.375rem 0 0; display: flex; align-items: center; justify-content: center; font-size: 60px;">
            ♻️
          </div>
          <div class="card-body">
            ...
            <a href="<?php echo e(route('artikel.index')); ?>" class="link-success text-decoration-none fw-bold">Baca selengkapnya →</a>
          </div>
        </div>
      </div>
    ...
    <div class="text-center mt-5">
      <a href="<?php echo e(route('artikel.index')); ?>" class="btn btn-outline-success btn-lg fw-bold">
        Lihat Semua Artikel
      </a>
    </div>
  </div>
...
<section class="py-5" style="background: linear-gradient(135deg, #228B22 0%, #1c751c 100%); color: white;">
  <div class="container text-center">
    ...
    <div class="d-flex gap-3 justify-content-center flex-wrap">
      ...
      <a href="<?php echo e(route('contact.index')); ?>" class="btn btn-outline-light btn-lg fw-bold px-5">
        Hubungi Kami
      </a>
    </div>
  </div>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\imanu\Downloads\WebProg-AOL\Web-Prog-AOL\resources\views/homepage.blade.php ENDPATH**/ ?>